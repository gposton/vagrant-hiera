  ...
  module Middleware
    ...
    class Setup
      ...
      def install_hiera
        ...
        @env[:vm].channel.sudo("apt-get install hiera=#{@hiera_version}")
      end
      ...
      def install_puppet
        ...
        @env[:vm].channel.sudo("apt-get install puppet-common=#{@puppet_version}")
        @env[:vm].channel.sudo("apt-get install puppet=#{@puppet_version}")
      end
      ...
      def install_hiera_puppet
        ...
        @env[:vm].channel.sudo("apt-get install hiera-puppet=#{@hiera_puppet_version}")
      end
